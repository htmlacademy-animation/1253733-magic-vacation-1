...
/***/ "./source/js/modules/screenLoading.js":
/*!********************************************!*\
  !*** ./source/js/modules/screenLoading.js ***!
  \********************************************/
/*! exports provided: default */
...
Object(_modules_screenLoading_js__WEBPACK_IMPORTED_MODULE_9__["default"])();


const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_8__["default"]();
fullPageScroll.init();

const animationTopScreenTextLine = new _modules_accentTypographyBuild_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__title`, 500, `active`, `transform`);
setTimeout(()=>{
  animationTopScreenTextLine.runAnimation();
}, 500);

const animationTopScreenTextLineData = new _modules_accentTypographyBuild_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__date`, 500, `active`, `transform`);
setTimeout(()=>{
  animationTopScreenTextLineData.runAnimation();
}, 10000);

const animationTopTitleHistory = new _modules_accentTypographyBuild_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.slider__item-title`, 500, `active`, `transform`);
setTimeout(()=>{
  animationTopTitleHistory.runAnimation();
}, 500);

const animationTopTitlePrize = new _modules_accentTypographyBuild_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.prizes__title`, 500, `active`, `transform`);
setTimeout(()=>{
